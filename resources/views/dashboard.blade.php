    ...
    <section align="center">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 col-xs-6 divpadding">
                    <a href="{{ route('codigosdeincidencias.index') }}"><i class="fa fa-th-list fa-4x"></i><br>CODIGOS DE
                        INCIDENCIA</a>
                </div>
                <div class="col-sm-4 col-xs-6 divpadding">
                ...
                <div class="col-sm-4 col-xs-6 divpadding">
                    <a data-url="{{ route('fechadecierre.create') }}" class="load-form-modal" data-toggle ="modal"
                        data-target='#form-modal'"><i class="fa fa-calendar fa-4x"></i><br>FECHA DE CIERRE</a>
                </div>
                <div class="col-sm-4 col-xs-6 divpadding">
                ...
                <div class="col-sm-4 col-xs-6 divpadding">
                    <a href="{{ route('biometrico.index') }}"><i class="fa fa-cloud-download fa-4x"></i><br>Actualizar
                        Registros de Biometrico</a>
                </div>
                <div class="col-sm-4 col-xs-6 divpadding">
                    <a href="{{ route('biometrico.get_checadas') }}"><i class="fa fa-hand-o-up fa-4x"></i><br>Ver
                        Checadas</a>
                </div>
                <div class="col-sm-4 col-xs-6 divpadding">
                ...
                <div class="col-sm-4 col-xs-6 divpadding">
                    <a href="{{ route('gys.index') }}"><i class="fa fa-tasks  fa-4x"></i><br>GyS</a>
                </div>
