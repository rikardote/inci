        ...
        <div class="form-group">
                    ...
                    <tbody>
                        @foreach ($checadas as $checada)
                            <tr>
                                ...
                                <td>{{ date('H:i', strtotime($checada->fecha)) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="col-md-7">
                ...
                <div align="center">
                    ...
                    <a data-url="{{ route('employees.edit', $employe->num_empleado) }}"
                        class="load-form-modal  panelColorGreen" data-toggle="modal" data-target='#form-modal'>
                        <span class="fa fa-pencil-square-o fa-3x" aria-hidden='true'></span>
                    </a>

                    @if (\Auth::user()->admin())
                        <a href="#" onclick='deleteRow(this, <?= $employe->num_empleado ?>)'> <span
                                class="fa fa-trash fa-3x"></span></a>
                    @endif
