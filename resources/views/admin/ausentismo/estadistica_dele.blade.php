<table class="table table-bordered">
	...
	<tr align="center">
		...
		<td><span class="badge">{{ $codigo_907->count ? $codigo_907->count:0}}</span></td>
		<td><span class="badge">{{ $codigo_100->count ? $codigo_100->count:0}}</span></td>
        <td><span class="badge">{{ $codigo_10->count+$codigo_14->count+$codigo_17->count+$codigo_41->count+$codigo_40->count+$codigo_42->count+$codigo_46->count+$codigo_47->count+$codigo_48->count+$codigo_49->count+
                                    $codigo_51->count+$codigo_53->count+$codigo_54->count+$codigo_55->count+$codigo_60->count+$codigo_62->count+$codigo_63->count+$codigo_94->count+$codigo_907->count+$codigo_100->count }}
            </span>
        </td>
