<table border="0" cellpadding="3" cellspacing="0"
    style="width:100%; border-collapse:collapse; margin-bottom:5px; border:none;">
    <tr style="border:none;">
        <td style="vertical-align:top; padding:5px; width:50%; border:none;">
            <img alt="ISSSTE" src="{{ isset($logoPath) ? $logoPath : public_path('images/60issste.png') }}"
                style="width:300px; height:75px;" />
        </td>
        <td style="text-align:right; vertical-align:top; padding:5px; border:none;">
            <div style="margin:0; font-size:14px; line-height:1.2; font-weight:bold;">REPRESENTACION ESTATAL BAJA
                CALIFORNIA</div>
            <div style="margin:0; font-size:14px; line-height:1.2; font-weight:bold;">SUBDELEGACION DE ADMINISTRACION
            </div>
            <div style="margin:0; font-size:12px; line-height:1.2; font-weight:bold;">DEPARTAMENTO DE RECURSOS HUMANOS
            </div>
        </td>
    </tr>
</table>
...
<table border="0" cellpadding="3" cellspacing="0"
    ...
    <tr style="border:none;">
        <td style="font-size:12px; border:none; text-align:left;">
            CLAVE DE ADSCRIPCION: <span style="font-weight:bold;">{{($dpto->code == "00104") ? "00105" :
                $dpto->code}}</span>
        </td>
