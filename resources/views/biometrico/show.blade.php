@extends('layout.main')
@section('title', 'Listado de Checadas correspondientes a la Qna: ' . $qna->qna . '/' . $qna->year . ' | ' . $dpto->code
    . ' - ' . $dpto->description)

@section('content')

    <a href="{{ route('biometrico.pdf', [$qna->id, $dpto->id]) }}" class="icon-pdf btn btn-warning"><i
            class="fa fa-file-pdf-o fa-1x"> Generar Reporte</i></a>
