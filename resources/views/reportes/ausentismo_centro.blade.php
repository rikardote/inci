		    ...
		    $('#container').highcharts({
		        ...
		        xAxis: {
		            categories: [
		                ...
		                '04 ({{$codigo_04->count ? $codigo_04->count:0}})',
		                '08 ({{$codigo_08->count ? $codigo_08->count:0}})',
		                '09 ({{$codigo_09->count ? $codigo_09->count:0}})',
		                '10 ({{$codigo_10->count ? $codigo_10->count:0}})',
		                '14 ({{$codigo_14->count ? $codigo_14->count:0}})',
		                '15 ({{$codigo_15->count ? $codigo_15->count:0}})',
		                '17 ({{$codigo_17->count ? $codigo_17->count:0}})',
						'30 ({{$codigo_30->count ? $codigo_30->count:0}})',
		                ...
		                '61 ({{$codigo_61->count ? $codigo_61->count:0}})',
		        ...
		        series: [{
		            ...
		            data: [
						{{$codigo_01->count ? $codigo_01->count:0}},
						{{$codigo_02->count ? $codigo_02->count:0}},
						{{$codigo_03->count ? $codigo_03->count:0}},
		            	{{$codigo_04->count ? $codigo_04->count:0}},
		            	{{$codigo_08->count ? $codigo_08->count:0}},
		            	{{$codigo_09->count ? $codigo_09->count:0}},
		            	{{$codigo_10->count ? $codigo_10->count:0}},
		            	{{$codigo_14->count ? $codigo_14->count:0}},
		            	{{$codigo_15->count ? $codigo_15->count:0}},
		            	{{$codigo_17->count ? $codigo_17->count:0}},
						{{$codigo_30->count ? $codigo_30->count:0}},
		            	{{$codigo_40->count ? $codigo_40->count:0}}, 
		            	{{$codigo_41->count ? $codigo_41->count:0}}, 
		            	{{$codigo_42->count ? $codigo_42->count:0}}, 
		            	{{$codigo_46->count ? $codigo_46->count:0}}, 
		            	{{$codigo_47->count ? $codigo_47->count:0}}, 
		            	{{$codigo_48->count ? $codigo_48->count:0}}, 
		            	{{$codigo_49->count ? $codigo_49->count:0}}, 
		            	{{$codigo_51->count ? $codigo_51->count:0}}, 
		            	{{$codigo_53->count ? $codigo_53->count:0}}, 
		            	{{$codigo_54->count ? $codigo_54->count:0}}, 
		            	{{$codigo_55->count ? $codigo_55->count:0}}, 
		            	{{$codigo_60->count ? $codigo_60->count:0}}, 
		            	{{$codigo_61->count ? $codigo_61->count:0}}, 
		            	{{$codigo_62->count ? $codigo_62->count:0}}, 
		            	{{$codigo_63->count ? $codigo_63->count:0}}, 
		            	{{$codigo_94->count ? $codigo_94->count:0}}, 
		            	{{$codigo_100->count ? $codigo_100->count:0}}]
